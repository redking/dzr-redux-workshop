				...
				<div className="container">
					...
					<div className="col-xs-12">
						<form className="form-inline">
							...
							<button type="button" className="btn btn-primary" onClick={() => this._addMessage()}>
								<i className="fa fa-comment" /> Send
							</button>
						</form>
						<hr />
						<button type="button" className="btn btn-default cycle" onClick={() => this._changeColor()}>
							<i className="fa fa-circle" style={{color}} /> Change header color
						</button>
					</div>
				</div>
			</div>
